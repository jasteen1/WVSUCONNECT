...
<head>
    ...
    <title>Offer Service - WVSU Marketplace</title>
...
<body>
    ...
    <div class="d-flex align-items-center mb-4">
        <a href="services.php" class="btn btn-outline-secondary rounded-circle me-3">
            <i class="bi bi-arrow-left"></i>
        </a>
        <div>
            <h2 class="fw-bold mb-0 text-primary">Offer a Service</h2>
            <p class="text-muted mb-0">Market your skills to the WVSU community.</p>
        </div>
    </div>
    ...
    <form action="process-add-service.php" method="POST" enctype="multipart/form-data">
        <div class="row g-4">
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="service_title" class="form-control" placeholder="e.g., Math Tutoring or Logo Design" required>
                        </div>
                        <div class="mb-0">
                            <label class="form-label fw-semibold">What exactly do you offer?</label>
                            <textarea name="description" class="form-control" rows="5" placeholder="Explain your process, tools you use, or what the student gets..." required></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4 text-center d-flex flex-column">
                        <h5 class="fw-bold mb-3 text-info text-start"><i class="bi bi-camera-reels me-2"></i>Service Cover</h5>
                        <div class="border border-dashed rounded-3 py-5 bg-light flex-grow-1 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <input type="file" name="service_image" class="form-control w-75 mx-auto" accept="image/*" required>
                            <p class="mt-2 text-muted small px-3">Upload a photo of your work or a professional profile shot.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <h5 class="fw-bold mb-3 text-success"><i class="bi bi-mortarboard me-2"></i>Specialization</h5>
                        <label class="form-label fw-semibold">Category of Expertise</label>
                        <select name="category" class="form-select" required>
                            ...
                            <option value="errands">Errands & Laundry</option>
                            <option value="events">Events & Hosting</option>
                        </select>
                        <div class="mt-4 p-3 bg-light rounded-3 small text-muted">
                            <i class="bi bi-lightning-charge-fill text-warning me-1"></i> 
                            <strong>Pro Tip:</strong> Most students look for "Academic Tutoring" during midterms and finals!
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        <h5 class="fw-bold mb-3 text-warning"><i class="bi bi-clock-history me-2"></i>Pricing & Rates</h5>
                        <div class="row g-3">
                            <div class="col-12 mb-2">
                                <label class="form-label fw-semibold">Base Rate (₱)</label>
                                <div class="input-group">
                                    <span class="input-group-text">₱</span>
                                    <input type="number" name="rate" class="form-control" placeholder="0.00" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Pricing Unit</label>
                                <select name="unit" class="form-select">
                                    <option value="hour">Per Hour</option>
                                    <option value="project">Per Project / Output</option>
                        ...
                        <div class="mt-4">
                            <button type="submit" name="submit" class="btn btn-primary w-100 btn-lg fw-bold shadow-sm py-3">
